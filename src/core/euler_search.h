...
//	float		 best_score;
	...
	void InitGrid(wxString wanted_symmetry_symbol, float angular_step_size, float wanted_phi_start, float wanted_phi_max, float wanted_theta_start, float wanted_theta_max, float wanted_psi_max, float wanted_psi_step, float wanted_psi_start, float wanted_resolution_limit, ParameterMap &parameter_map, int wanted_parameters_to_keep);
